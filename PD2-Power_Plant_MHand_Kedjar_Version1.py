...
# MAGIC This notebook is an end-to-end exercise of performing Extract-Transform-Load (ETL) and Exploratory Data Analysis (EDA) on a real-world dataset, and then applying several different MACHINE LEARNING (ML) algorithms to solve a SUPERVISED REGRESSION problem on the dataset.
# MAGIC 
...
# MAGIC %sql
# MAGIC select V as Exhaust_Vacuum_Speed, PE as Power from power_plant

# COMMAND ----------

# MAGIC %sql
# MAGIC select AP as Atmospheric_Pressure, PE as Power from power_plant

# COMMAND ----------

# MAGIC %sql
# MAGIC select AT as Temperature, V as Exhaust_Vacuum_Speed, AP as Atmospheric_Pressure, RH as Relative_Humidity, PE as Power from power_plant
...
seed = 1800009193L
(split20DF, split80DF) = datasetDF.randomSplit([0.20, 0.80], seed)
